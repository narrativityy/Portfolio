          ...
          <div className="row align-items-start">
            <div className="col me-1">
              <p className="fw-lighter">
                ...
                been fascinated with tinkering with all kinds of technology. My
                passion had grown to the point where I wanted to build my own
                computer, and I did just that. I spent hours researching and
                learning about the different components and how they worked
                together. I was so proud of myself when I finally got it to boot
                up for the first time. I was hooked. I knew that I wanted to
                work with computers for the rest of my life. I slowly started
